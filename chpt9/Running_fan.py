# This program  displays a fan running
...
class Fan:
    ...
    def displayFan(self, startingAngle):
        ...
        self.canvas.create_arc(width / 2 - radius, height / 2 - radius, width / 2 + radius, height / 2 + radius,
                               start=self.startingAngle + 0, extent=30, fill="green", tags="fan")

        self.canvas.create_arc(width / 2 - radius, height / 2 - radius, width / 2 + radius, height / 2 + radius,
                               start=self.startingAngle + 90, extent=30, fill="purple", tags="fan")

        self.canvas.create_arc(width / 2 - radius, height / 2 - radius, width / 2 + radius, height / 2 + radius,
                               start=self.startingAngle + 180, extent=30, fill="blue", tags="fan")
